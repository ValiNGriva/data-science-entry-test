...
# Your answer (Reason 1): prevent missed instructions
# Your answer (Reason 2): clear structure

# Q8c: What is ONE strength of the prompt you did NOT choose?
# Your answer: The context of the task
...
"""
Role: You are a data analyst helping a retail marketing team.
Context:  The team has just finished a three-month campaign and collected
customer feedback through an online survey. The data has 500 responses 
containing age group, product purchased, satisfaction rating (1-5), and 
written comments in a spreadsheet.
Task: Analyse customer survey data and prepare insights in short paragraph
Steps:
1. Identify age groups and products with the lowest satisfaction scores.
2. Extract the most common themes from the written comments.
3. Summarise findings in an executive summary paragraph.
